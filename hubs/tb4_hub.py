            ...
            if index + 1 >= len(self.resultDf):
                ...
                for n in range(1, 8):
                    ...
                    if bets > 0:
                        ...
                        self.mainWin.tb4.item(n, index).setText(str(bets))
                        self.mainWin.tb4.item(n + 12, index).setText(str(bets))
                    elif fBets > 0:
                        self.mainWin.tb4.item(n, index).setBackground(QBrush(yellow))
                        self.mainWin.tb4.item(n + 12, index).setBackground(QBrush(yellow))
                        self.mainWin.tb4.item(n, index).setText(str(fBets))
                        self.mainWin.tb4.item(n + 12, index).setText(str(fBets))
                    else:
